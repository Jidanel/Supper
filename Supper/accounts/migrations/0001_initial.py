    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.CharField(help_text='Région administrative du Cameroun', max_length=50, verbose_name='Région')),
                ('departement', models.CharField(blank=True, max_length=50, verbose_name='Département')),
            ...
            options={
                ...
                'ordering': ['region', 'nom'],
                'indexes': [models.Index(fields=['code'], name='accounts_po_code_1cbc06_idx'), models.Index(fields=['region', 'type'], name='accounts_po_region_dfd1ed_idx'), models.Index(fields=['is_active'], name='accounts_po_is_acti_7958c8_idx')],
            },
        ),
        migrations.CreateModel(
